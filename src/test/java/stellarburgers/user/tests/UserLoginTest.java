...
public class UserLoginTest {
    ...
    public void checkUserLoggedInSuccessfully() {
        accessToken = assertions.successIsTrue(userSteps.userLoggedInSuccessfully());
    }

    @Test
    @DisplayName("Check user authorization with incorrect email")
    public void checkUserWithFakeEmailLoggedInFailed() {
        accessToken = assertions.successIsFalseUnauthorized(userSteps.userWithFakeEmailLoggedInFailed());
    }
